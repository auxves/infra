...
in
{
  ...
  config = lib.mkIf (cfg.enable) {
    ...
    containers = {
      runner = {
        image = "data.forgejo.org/forgejo/runner:12.11.1@sha256:a1a2885261a0b8337d4791dd6949651117206741ba66423c24a57c107a64d4a8";
      ...
      podman = {
        image = "quay.io/podman/stable:v5.8.2@sha256:766815d247ce0edfd8774770371d293728b0b500a219f35de98b408100f5d412";
        user = "root";
