...
in
{
  ...
  config = lib.mkIf (cfg.enable) {
    ...
    containers = {
      runner = {
        image = "data.forgejo.org/forgejo/runner:6.3.0@sha256:29f2ecb703efba53f116d8c4d955eb247ca073351050d8405a8100e12fd5717b";
      ...
      podman = {
        image = "quay.io/podman/stable:v5.4.1@sha256:3e687c43c9bb746186aa04af32b7939d834f3c1a8e18439e89fd4aa8ec1d8452";
        user = "podman";
